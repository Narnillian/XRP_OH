...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    JoystickButton joystickStartButton = new JoystickButton(m_controller, 8);
    joystickStartButton
        .onTrue(new InstantCommand(() -> {
            arcadeDrive = !arcadeDrive;
            if (arcadeDrive) m_drivetrain.setDefaultCommand(getArcadeDriveCommand());
            else m_drivetrain.setDefaultCommand(getTankDriveCommand());
